...
import { ThumbsUp, MessageCircle, Check, Edit2, Trash2, Flag } from "lucide-react";
            ...
            <div className="mt-4 flex flex-wrap items-center gap-4">
              ...
              {isQuestionAuthor && !answer.isAccepted && (
                <button
                  ...
                  className={cn(
                    "flex items-center gap-1.5 text-xs font-medium text-muted-foreground hover:text-primary transition-colors",
